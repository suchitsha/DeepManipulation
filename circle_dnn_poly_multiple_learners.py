...
def train_dnn(training_set):     
    ...
    # Fit
    regressor.fit(input_fn=lambda: input_fn(training_set), steps=50)
    return regressor
...
def learnMotion():
    ...
    skip = 0
    iterations = 5000      # trajectories to be generated

    #train
    training_set = process_data("/home/shar_sc/Documents/DirtDetection/data/motion/data2_40_10.p",app.output)# data2_12900_10.p",app.output)#data2_8000_10.p",app.output)
    ...
    data = []
    f = open("/home/shar_sc/Documents/DirtDetection/data/motion/data2_12900_10.p","rb") #data_200_10.p","rb")    
    while True:
        try:
...
def evaluate_data_from_file_dnn_poly(regressor, data, name=""):
    ...
    for data_point in data:
        #TODO
        #TODO#TODO
        #check if data_point[-1] is to be used or data_point[-1][4 or 6] to be used
        app.idle_cfg["right_arm"] = data_point[6]#[-1][6]
        app.rave.set_config_dict(app.idle_cfg)
    ...
    for i in xrange(num_points):
        ...
        app.nn = tf.contrib.learn.Estimator(model_fn=model_fn, model_dir="/home_local/shar_sc/learn_motion_models_secondary_cart_motorpos_1", params=model_params)
        ...
        #app.nn.partial_fit(input_fn=get_train_inputs,steps=1) # train once cause the app.cost is not yet updated
        ...
        #TODO wrong maybe, estimated_pos_sec should be center + sum_sec + sum_primary 
        ...
        #TODO multiplied it by 100 to make it in meters
