...
def execute(self):
    base_dr = "/home_local/shar_sc/data_from_robot/random"
    #read directory
...
def replay_and_save():
    ...
    try:
        ...
        data_file = open("/home/shar_sc/Documents/DirtDetection/data/motion/data_rec2.p","a+b")#wb
        for dat in trial:    
...
def save_data(motor_pos,torso):
    ...
    for i in range(10):
        ...
        trial.append([i, pos, goal_delta, goal_pos, motor_pos_center, motor_pos_delta, motor_pos_step, pos_cart, goal_delta_cart, goal_pos_cart, torso_center,torso_motor_delta,torso_step ])
    #sleep(5)
    print trial    
    return trial
