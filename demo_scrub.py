...
def train_dnn(training_set):     
    ...
    regressor = tf.contrib.learn.DNNRegressor(feature_columns=feature_cols,
                                            ...
                                            #real robot data
                                            model_dir="/home_local/shar_sc/learn_motion_models_scrub2" # scrub
...
def learnMotion():
    ...
    if(not dnn_prerecorded):
        ...
        # for dnn
        #train
        training_set = process_data("/home/shar_sc/Documents/DirtDetection/data/motion/data_rec_scrub1.p",app.output)#scrub1.p",app.output)#accum2.p",app.output)#data_rec_circle60.p",app.output)#data2_21300_10.p",app.output)
    ...
    if (demo):
        ...
        print r
        print app.particles
        x_part = app.particles[0][r]
        y_part = app.particles[1][r]
        z_part = 0.005 #TODO 
    ...
    if (dnn_prerecorded):
        ...
        data = []
        f = open("/home/shar_sc/Documents/DirtDetection/data/motion/data_rec_scrub1.p","rb")#scrub1.p","rb")#accum2.p","rb")#data_200_10.p","rb")
        while True:
            try:
