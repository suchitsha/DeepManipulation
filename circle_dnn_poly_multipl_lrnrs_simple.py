...
#  'parameters': [],
#  'position': (740, 410, -1, -1),
#  'transitions': [('out', 'dummy2')]}
### end of header
import time
import math
import random
...
def init(self):
    ...
    if app.simple == True:
        ...
        app.COLUMNS_sec = ["time", "x", "y", "z", "e_x","e_y","e_z", "out_0","out_1","out_2","out_3","out_4","out_5","out_6"]        
        ...
        app.FEATURES_sec = ["time", "x", "y", "z","r1","r2","r3","p0","p1","p2","p3","p4","p5","p6","e_x","e_y","e_z"]
        app.COLUMNS_sec = ["time", "x", "y", "z","r1","r2","r3","p0","p1","p2","p3","p4","p5","p6", "e_x","e_y","e_z", "out_0","out_1","out_2","out_3","out_4","out_5","out_6"]        
        app.LABEL_sec = ["out_0","out_1","out_2","out_3","out_4","out_5","out_6"]
        if app.output == 0:    
...
def train_dnn(training_set):     
    ...
    regressor = tf.contrib.learn.DNNRegressor(feature_columns=feature_cols,
                                            ...
                                            model_dir="/home_local/shar_sc/learn_motion_models_temp2" # temp1 #wipe1"
...
def evaluate_data_from_file_dnn_poly(regressor, data, name=""):
    ...
    for i in xrange(num_points):
        ...
        app.nn = tf.contrib.learn.Estimator(model_fn=model_fn, model_dir="/home_local/shar_sc/learn_motion_models_secondary_cart_motorpos_7", params=model_params)
        ...
        def get_train_inputs():
            if app.simple == True:
                ...
                if app.output == 0:
                    ...
                    #TODO are all these parameters necessary? yes but only e_x,e_y,e_z should suffice, maybe time, or later sensor inputs
                    x = tf.constant([ [ i,list_x1[0],list_y1[0],list_z1[0],reached_frame[0:3,3][0],reached_frame[0:3,3][1],reached_frame[0:3,3][2],predictions[0][0],predictions[0][1],predictions[0][2],predictions[0][3],predictions[0][4],predictions[0][5],predictions[0][6], e_x, e_y, e_z ] ])                              
