...
def train_dnn(training_set):     
    ...
    regressor = tf.contrib.learn.DNNRegressor(feature_columns=feature_cols,
                                            ...
                                            #for motor pos that went upward instead of horizontal, with low entropy
                                            #model_dir="/home_local/shar_sc/learn_motion_models"
                                            # for motor pos works fine
...
def learnMotion():
    ...
    margin = 0.0
    radius = 0.15
    num_points = 60 #10 # points on circle
    ...
    if(not dnn_prerecorded):
        ...
        # for dnn
        #train
        #training_set = process_data("/home/shar_sc/Documents/DirtDetection/data/motion/data2_100_10.p",app.output)
        training_set = process_data("/home/shar_sc/Documents/DirtDetection/data/motion/data2_8888_250_60.p",app.output)
    ...
    if (dnn_prerecorded):
        ...
        data = []
        f = open("/home/shar_sc/Documents/DirtDetection/data/motion/data2_8888_250_60.p","rb")
